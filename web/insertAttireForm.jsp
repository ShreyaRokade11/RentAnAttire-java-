...
<head>
    ...
    <title>Insert Mens Attire</title>
...
<body>
    <div class="container">
        <h1>Insert Attire</h1>
        <form id="attireForm" action="insertAttireServlet" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
    ...
    <script>
        ...
        function updateCategorySubcategories(category) {
            ...
            if (category == 1) { // Men's Category
                options = [
                    { id: 1, name: 'Sherwani' },
                    { id: 2, name: 'Blazer' },
                    { id: 3, name: 'Kurta' },
                    { id: 4, name: 'Indowestern' },
                    { id: 5, name: 'Navaratri Kurtas' },
                    { id: 6, name: 'Ethnic Jackets' },
                    { id: 7, name: 'Pagadi' }
                ];
            }
