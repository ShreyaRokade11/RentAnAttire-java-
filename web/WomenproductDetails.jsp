...
<head>
    ...
    <title>Product Women Details | RentAnAttire</title>
    <style>
        body {
...
<body>
    ...
    <div class="product-details-container">
        <%
            ...
            if (productId == null || productId.isEmpty()) {
                ...
                try {
                    ...
                    String query = "SELECT description, price, image, status FROM Womens WHERE id = ?";
        ...
        <div class="product-info">
            ...
            <!-- Product rental form -->
            <form action="ProcessRentalWomen.jsp" method="POST">
            ...
            <a href="ProductWomen.jsp" class="btn btn-back">Back to Products</a>
        </div>
        <%
                    } else {
