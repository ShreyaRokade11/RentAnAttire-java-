...
<div class="container">
    <h1>View Men's Attires</h1>

    <!-- Button group -->
    <div class="button-group">
        <a href="insertAttireForm.jsp">Add New Attire</a>
        <a href="UpdateMensAttire.jsp">Update Attire</a>
        <a href="deleteAttire.jsp">Delete Attire</a>
    </div>
        ...
        <tbody>
            ...
            %>
                <tr>
                    ...
                    <td>$<%= deposit %></td>
                    <td>
                        <a href="UpdateMensAttire.jsp?id=<%= id %>" class="action-btn btn-edit">Edit</a>
...
document.getElementById("confirmDeleteBtn").addEventListener("click", function() {
    if (deleteId != null) {
        ...
        window.location.href = "deleteAttire.jsp?id=" + deleteId;
    }
});
