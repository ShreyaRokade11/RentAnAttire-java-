    ...
    <div class="navbar">
      ...
      <nav>
        <ul>
         ...
         <a href="cart.jsp" clspass="login-btn">cart</a>
        ...
        <div class="product-container" id="productContainer">
            <%
                ...
                try {
                    ...
                    // Fetch all products
                    String query = "SELECT id, description, price, image, size, status FROM Mens";
                    ...
                    <div class="product-details">
                        ...
                        <!-- Add to Cart Button -->
                         <a href="AddToCart.jsp?id=<%= id %>&description=<%= description %>&price=<%= price %>&size=<%= size %>" class="btn-rent">Add to Cart</a>
                          ...
                          <!-- Rent Now Button -->
                          <a href="MenproductDetails.jsp?id=<%= id %>" class="btn-rent" style="background: #007bff;">Rent Now</a>
                    </div>
                </div>
            <%
                    }
