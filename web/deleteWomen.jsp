...
<head>
    ...
    <title>Delete Womens Attire | RentAnAttire</title>
...
<%
    ...
    if (id != null && !id.isEmpty()) {
        try {
            ...
            String deleteQuery = "DELETE FROM Womens WHERE id = ?";
...
<div class="container">
    <h1>Delete Attire</h1>
    <form action="deleteWomenServlet" method="post" onsubmit="return validateForm();">
