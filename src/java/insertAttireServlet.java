...
@WebServlet("/insertAttireServlet")
@MultipartConfig(maxFileSize = 16177216) // Max file size: 16MB
public class insertAttireServlet extends HttpServlet {
 private static final String IMAGE_DIR = "web/image";  // Folder to store images
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String query = "INSERT INTO Mens (name, description, price, status, size, duration, deposit, image, subcategory_id) "
                         + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
